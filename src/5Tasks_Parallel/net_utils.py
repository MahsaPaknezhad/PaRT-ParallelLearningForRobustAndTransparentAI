...
def get_network(args):
    ...
    if args['arch'] == 'vgg16':
        ...
        net = googlenet(args['total_num_classes'])
        ...
        net = resnet18(args['M'], args['num_tasks'], args['total_num_classes'])
    elif args['arch'] == 'resnet34':
        from models.resnet import resnet34
        net = resnet34(args['M'], args['num_tasks'], args['total_num_classes'])
    elif args['arch'] == 'resnet50':
        from models.resnet import resnet50
        net = resnet50(args['M'], args['num_tasks'],  args['total_num_classes'])
    elif args['arch'] == 'resnet101':
        from models.resnet import resnet101
        net = resnet101(args['M'], args['num_tasks'], args['total_num_classes'])
    elif args['arch'] == 'resnet152':
        from models.resnet import resnet152
        net = resnet152(args['M'], args['num_tasks'], args['total_num_classes'])
